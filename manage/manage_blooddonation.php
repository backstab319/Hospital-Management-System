...
<body>
    ...
    <div class="container text-center my-4 col-lg-6 col-xl-6">
        <h1 class="display-4">View Blood Donor's Data</h1>
            ...
            <?php
                ...
                function showdonation(){
                    ...
                    if($result->num_rows > 0){
                        ...
                        echo "<p class='lead'>There are no donors</p>";
                    }
                }
                function show($result){
                    ...
                    while($row = $result->fetch_assoc()){
                        ...
                        echo "<tr><td>".$row['name']."</td><td>".$row['phone']."</td><td>".$row['age']."</td><td>".$row["gender"]."</td><td>".$row["blood_group"]."</td><td>".$row["weight"]."</td></tr>";
                    }
                    echo "</table>";
                }
            ?>
    ...
    <div class="container text-center my-4 col-lg-6 col-xl-6">
        <h1 class="display-4">Delete Blood Donor's Form</h1>
        <div class="container text-center col-lg-7 col-xl-7">
            <div class="form-group">
                <form method="POST" action="manage_blooddonation.php">
                    <label for="del_val">Select donors name to delete</label>
                        <select class="form-control my-2" name="delval" id="del_val">
                            <?php
                                dispoption();
                                function dispoption(){
                                    global $conn;
                                    $sql = "SELECT name FROM blood_donation";
                                    $result = $conn->query($sql);
                                    if($result->num_rows > 0){
                                        while($row = $result->fetch_assoc()){
        ...
        <?php
            ...
            function delete(){
                global $conn;
                $delval = $_POST["delval"];
                $sql = "DELETE FROM blood_donation WHERE name = '$delval'";
                $conn->query($sql);
            }
        ?>
    </div>
